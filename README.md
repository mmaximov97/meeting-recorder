...
окна, диалоги разрешений и звучание готовых файлов. 223 теста зелёные, прогон нативно на macOS.
Windows-часть портом не менялась.
...
- `bundle.macOS.minimumSystemVersion` — `11.0`, хотя приложению нужна 14.4. Подъём до 12.0 и
  ...
  `docs/2026-08-10-macos-port-design.md`, проверка на собранном бандле —
