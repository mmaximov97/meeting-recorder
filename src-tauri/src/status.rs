...
pub const NO_SYSTEM_AUDIO: &str = "Запись системного звука запрещена. \
     ...
     работает и пишет только микрофон. Разрешить можно в Системных настройках \
